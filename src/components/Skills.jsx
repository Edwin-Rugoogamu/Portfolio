    ...
    return (
        <div>
            <label className={style.skill}>
                            <h5 style={{textDecoration:"underline", color:"aqua"}}>Web Development</h5>
                            ...
                            <h5 style={{textDecoration:"underline", color:"aqua"}}>DevOPs</h5>
                            <p> Cucumber, Docker , Github Actions, Jenkins, Blue Ocean and Aws  </p>
                            <h5 style={{textDecoration:"underline", color:"aqua"}}>UI/UX</h5>
                            <p> Human-Centered Design, figma, </p>
                            <h5 style={{textDecoration:"underline", color:"aqua"}}>Others</h5>
